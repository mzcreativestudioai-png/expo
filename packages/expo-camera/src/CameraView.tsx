...
export default class CameraView extends Component<CameraViewProps> {
   ...
   * [`scanDocumentAsync`](#scandocumentasyncoptions) — VisionKit's `VNDocumentCameraViewController` on iOS, or the
   * ML Kit document scanner on Android, which requires Google Play Services.
   */
